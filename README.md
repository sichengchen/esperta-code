...
**Pluggable agents** — Includes a Claude Code adapter out of the box. Add Codex, Aider, or any CLI agent through a simple adapter interface. Agent CLIs are installed and authenticated separately.
